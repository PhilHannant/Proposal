...
\begin{itemize}
\item Encoding - This will be set to ``''PCM.signed``'', representing audio encoded to the native linea pulse code modulation, where quantization levels are linearly uniform [https://en.wikipedia.org/wiki/Pulse-code_modulation].
